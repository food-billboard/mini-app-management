...
const TestModal = forwardRef<TestModalRef>((props, ref) => {
  ...
  return (
    <Modal title="第三方接口测试" onOk={handleOk} onCancel={handleCancel} open={visible}>
      {thirdData?.params && (
        <CodeEditor value={params} onChange={setParams} language="json" height={100} />
      )}
      <Button
        style={{ marginTop: 20 }}
        type="primary"
